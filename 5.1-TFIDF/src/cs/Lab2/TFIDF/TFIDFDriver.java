...
import org.apache.hadoop.util.ToolRunner;
	...
	public static void main(String[] args) throws Exception {
		      ...
		      int res = ToolRunner.run(new Configuration(), new TFIDFDriver(), new String [] {"inputs/", "output/"});
		      System.exit(res);
		   }
		   ...
		   public int run(String[] args) throws Exception {
		      ...
		      Path outputFilePath1 = new Path("/home/cloudera/workspace/5.1-TFIDF/paths/path1");
		      Path outputFilePath2 = new Path("/home/cloudera/workspace/5.1-TFIDF/paths/path2");
		      Path outputFilePath3 = new Path("/home/cloudera/workspace/5.1-TFIDF/paths/path3");
